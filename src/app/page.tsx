...
function HomeContent() {
 ...
 const {mutate: createRoom} = useMutation({
  ...
  return (
    ...
    <p className="text-zinc-500 text-xs mt-1">All Messages Were Permantly Deleted</p></div>}

    {error === "room-not-found" && <div className="bg-red-950/50 border border-red-900 p-4 text-center">
    <p className="text-red-500 text-sm font-bold">ROOM NOT FOUND</p>
    <p className="text-zinc-500 text-xs mt-1">This Room Does Not Exist</p></div>}
    ...
    <div className="text-center space-y-2">
      ...
      <div className="space-y-5">
        <div className="space-y-2">
          <label htmlFor="username" className="flex items-center text-zinc-500">Identity</label>
